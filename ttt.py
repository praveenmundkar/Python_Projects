...
# extract_cat_sub_cat()
login("pravinbiloli123@gmail.com", "Praveen@222")
...
for cat in category:
    ...
    # driver.find_element(By.XPATH, "//a[contains(@id,'ember86')]").click()
    # driver.find_element(By.XPATH, "//button[contains(@id,'ember78')]").click()
    # driver.find_element(By.XPATH, "// input[contains( @ id, 'jobs-search-box-key')]").click()
    # driver.find_element_by_css_selector(
    #     "input[class='jobs-search-box__text-input jobs-search-box__keyboard-text-input']").send_keys(list_of_sub_jobs[0])
...
#             try:
#                 unwanted = driver.window_handles[1]
#                 driver.switch_to(unwanted)
#                 driver.close()
#                 try:
#                     unwanted = driver.window_handles[1]
#                     driver.switch_to(unwanted)
